  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-6 lg:px-24 relative">
      ...
      <div className="max-w-4xl relative z-10">
        <p className="font-mono text-primary mb-4 animate-fade-up">Hi, my name is</p>
        ...
        <p className="text-muted-foreground text-lg max-w-xl mb-8 animate-fade-up-delay-3 leading-relaxed">
          Full-stack developer with <span className="text-foreground font-medium">1+ years</span> of experience 
          specializing in building scalable SaaS applications. I craft enterprise-grade solutions using 
          <span className="text-primary"> MERN</span>, <span className="text-primary">Golang</span>, and 
